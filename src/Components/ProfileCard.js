...
function ProfileCard({data, functio}) {
  return (
    ...
    <img src={data.profile} alt='test' width={"160px"} style={{marginBottom: "10px"}}></img>
    <div>
        <div>
            <h3 style={{color:"white",fontSize: "25px"}}>About Workshop</h3>
        ...
        <div>
            <h3 style={{color:"white" , fontSize: "25px"}}>Bio - Leslie Cox</h3>
            <p style={{color:"white" , fontSize: "15px"}}>
